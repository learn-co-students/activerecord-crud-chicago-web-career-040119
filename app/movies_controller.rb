...
def can_be_found_updated_and_saved
  ...
  u_movie = Movie.find_by(title: "Awesome Flick")
  u_movie.title = "Even Awesomer Flick"
  u_movie.save
end
...
def can_update_using_update_method
  ...
  u_movie = Movie.find_by(title: "Wat?")
  u_movie.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  u_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  u_movie.destroy
end
